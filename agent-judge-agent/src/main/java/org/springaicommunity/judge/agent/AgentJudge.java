 ...
 *
 * <pre>{@code
 * // Create adapter for your agent client
 * JudgeAgentClient agentClient = (goal, workspace) -> {
 *     AgentClientResponse response = myAgentClient.goal(goal)
...
public class AgentJudge implements JudgeWithMetadata {
	...
	private final JudgeAgentClient agentClient;

	private final String criteria;

	private final String goalTemplate;

	private AgentJudge(String name, String description, JudgeAgentClient agentClient, String criteria,
			String goalTemplate) {
	...
	public Judgment judge(JudgmentContext context) {
		...
		// Execute agent
		JudgeAgentResponse response = agentClient.execute(goal, context.workspace());

		// Parse agent response
		return parseAgentResponse(response.result(), context);
	}
	 ...
	 */
	public static AgentJudge codeReview(JudgeAgentClient agentClient) {
	 ...
	 */
	public static AgentJudge securityAudit(JudgeAgentClient agentClient) {
		return builder().agentClient(agentClient)
			.name("SecurityAudit")
	...
	public static class Builder {
		...
		private JudgeAgentClient agentClient;
		...
		public Builder agentClient(JudgeAgentClient agentClient) {
			this.agentClient = agentClient;
			return this;
		}
		...
		public AgentJudge build() {
			if (agentClient == null) {
				throw new IllegalStateException("JudgeAgentClient is required");
			}
			if (criteria == null) {
