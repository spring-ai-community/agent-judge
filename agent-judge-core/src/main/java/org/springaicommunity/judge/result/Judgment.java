...
package org.springaicommunity.judge.result;
...
public record Judgment(Score score, JudgmentStatus status, String reasoning, List<Check> checks,
	...
	public static Judgment pass(String reasoning) {
		return builder().score(new org.springaicommunity.judge.score.BooleanScore(true))
	...
	public static Judgment fail(String reasoning) {
		return builder().score(new org.springaicommunity.judge.score.BooleanScore(false))
	...
	public static Judgment error(String reasoning, Throwable error) {
		Builder builder = builder().score(new org.springaicommunity.judge.score.BooleanScore(false))
